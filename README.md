...
这个还是比较容易的，有很多工具可以实现。  
其中全能的有：BEnquote Editor和torrent-file-editor，他俩具有直接修改BEnquote编码的功能，可以修改、增加、删除所有字段。  
...
这个具有BEnquote编码编辑功能的少量工具可以实现。目前测试过的，只有BEnquote Editor和torrent-file-editor可以实现。  
由于国内介绍BEnquote Editor的比较多，我就来以torrent-file-editor举例吧。  
举例Example  
...
【找了许久的神器】chtor举例：  
这个chtor工具相比其他BEnquote工具较为完整，可以修改增加删除任何字段.可以与GUI工具BEnquote Editor和torrent-file-editor媲美.  
...
***transmission-edit -r old-passquote new-passquote ~/.config/transmission/torrents/*\\.torrent***  
2.添加种子的tracker  
